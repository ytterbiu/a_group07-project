...
Further details on the COVID-19 exclusion window are discussed in Appendix
...
What constitutes “legitimate” market activity is itself debatable. One could
potentially exclude other volatile periods, but we felt doing so would not align 
with the aim of this analysis, which is to test how well the standard log-return
model describes the behaviour of the Nasdaq Composite under _realistic_ / 
_actual_ market conditions. 
