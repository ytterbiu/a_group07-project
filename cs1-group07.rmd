...
The log-returns were split into fourteen  6-month periods (Table
\@ref(tab:days-per-six-month-period)). Although the Jan 2020–Jun 2020 window
contains relatively fewer observations, we assume it remains representative of
...
\qquad\, \text{to produce larger or smaller values than the others}
\end{cases}
$$
