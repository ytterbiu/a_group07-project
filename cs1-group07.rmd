...
$\big[`r formatC(var_ci_min_bca[1], format = "fg", digits = 4)`,
`r formatC(var_ci_min_bca[2], format = "fg", digits = 4)`\big]$
and
$\big[`r formatC(var_ci_max_bca[1], format = "fg", digits = 4)`,
`r formatC(var_ci_max_bca[2], format = "fg", digits = 4)`\big]$,
respectively. Or in scientific notation the 95% CI for the minimum variance
subsample is [`r formatC(var_ci_min_bca[1], format = "e", digits = 2)`,
