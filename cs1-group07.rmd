...
# start boundary: first 6-month block that contains the first date
...
# end boundary: first boundary *after* the last date
last_date <- max(dates)
...
# human-readable labels: "01 Jan 2018 - 30 Jun 2018", etc.
...
our analysis for &#167;\@ref(elementThr) did not find statistical evidence to
